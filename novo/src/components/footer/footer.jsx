...
const Footer = () => {
    return (
        <div className="flex flex-col gap-4 items-center self-stretch px-5 pt-12 mt-16 w-full text-base font-light text-center text-white bg-indigo-900 rounded-t-xl">
