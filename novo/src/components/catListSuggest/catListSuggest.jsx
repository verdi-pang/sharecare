const CatListSuggest = () => {
  ...
  return (
    <div className="mt-3 flex w-full flex-col flex-wrap content-start justify-center px-4 py-2.5 text-center text-sm font-medium leading-5 tracking-normal text-slate-500">
