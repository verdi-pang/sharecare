...
const CatSelectBar = () => {
    ...
    return (
        <div className="flex gap-2 text-sm font-medium tracking-normal leading-5 text-center text-slate-500 overflow-x-auto">
            {/* {catMenu.map((cat) => (
            ...
            <div className="flex gap-2 mt-6 text-sm font-medium tracking-normal leading-5 text-center text-slate-500">
